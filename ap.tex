...
\dictterm{adj}{(\textsc{comp} bajeke͞a, \textsc{supl} bajeke͞am) inny, obcy}

\dictword{bajeker}[ˈba.ʐɛ.ker]
\dictterm{n}{(\textsc{pl} bajekeros) obcy ludzie, inni ludzie}
...
\dictterm{n}{(\textsc{pl} beístos) (\textsc{fem}) bestia}
...
\dictword{bowa}[ˈbo.wa]
\dictterm{n}{(\textsc{pl} bowaji) (\textsc{fem}) jajo, jajko}
...
\dictterm{n}{(\textsc{pl} faájis) (\textsc{fem}) ładunek}
...
\dictterm{n}{(\textsc{pl} furetos) wicher}
...
\dictterm{n}{(\textsc{pl} gusteji) (\textsc{fem}) uciecha, szczęście}
...
\dictterm{n}{(\textsc{pl} huarneji) słowo}
...
\dictword{hufay}[ˈxu.faz]
\dictterm{n}{(\textsc{pl} hufayos) tłuszcz}
...
\dictterm{n}{(\textsc{pl} iényihuarneji) hasło}
...
\dictterm{n}{(\textsc{pl} kachistos) (\textsc{fem} kachistera) nauczyciel}
...
\dictterm{n}{(\textsc{pl} mahetanos) pociąg (pojazd)}
