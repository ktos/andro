...
\dictterm{n}{(\textsc{pl} imṕigetiros) (\textsc{fem}) służba (np. utrzymania ruchu)}
...
\dictterm{n}{(\textsc{pl} moroji) (\textsc{fem}) piłka}
...
\dictterm{n}{(\textsc{pl} oyosenaji) (\textsc{fem}) okulary}
...
\dictterm{adj}{(\textsc{comp} ozeye, \textsc{supl} ozeyem) trudny, trudniejszy, najtrudniejszy}
...
\dictword{vechiret}[ˈvɛ.t͡ʂi.ret]
\dictterm{adj}{(\textsc{comp} vechirede, \textsc{supl} vechiredem) głupi, głupszy, najgłupszy}

\dictword{vechireder}[ˈvɛ.t͡ʂi.rɛ.dɛr]
\dictterm{n}{(\textsc{pl} vechiredeji) (\textsc{fem} vechiredera) głupiec, głupek}
...
\dictterm{n}{(\textsc{pl} yoketos) guzik, przycisk, klawisz}
...
\dictterm{adj}{(\textsc{comp} zeuye͞a, \textsc{supl} zeuye͞am) gruby}
