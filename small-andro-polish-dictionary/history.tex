...
\note{Tekst ten, \emph{ze͞uye chido yi boso hinaja va fint wirklo abe gepito laák}
...
\begin{itemize}
    ...
    \item dialekt południowy, stosujący długie samogłoski (np. /a:/) zamiast rozziewu ze zmianą akcentu oraz [ɨ] zamiast [ʏ],
