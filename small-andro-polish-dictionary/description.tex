...
\examples{Mi veydi yasaji.}{Widzę [kogo, co?] węgorze.}

\examples{Mi veydi chu yasaji.}{Widzę [kogo, co?] węgorze.}

\example{Myi keromamerey esi dowo chu yasaji.}{Mój poduszkowiec jest pełen
[kogo, czego?] węgorzy.}
...
\example{Vige hallo͞i nome yi Ori!}{Niech będzie chwała imieniu Boga!}
...
Jako monarchia, Cesarstwo posiada szereg tytułów szlacheckich, i w stosunku do
osób nimi obdarzonych w wysoce formalnym języku należy się nimi posługiwać
zamiast lub obok zaimków osobowych. W języku mniej formalnym stosuje się te
określenia najczęściej jako przyrostek funkcyjny (na wzór
np.~\emph{Koolder-epié}).

Dodatkowo, część z krajów związkowych posiada rodziny królewskie lub książęce,
które to zawsze powinny być odpowiednio tytułowane.

\begin{itemize}
	\item \emph{kyige/kyige͞a} -- król/królowa,
	\item \emph{kigeje/kigeje͞a} -- książę/księżna/księżniczka
	...
	\item \emph{arḱer/arḱera} -- ogólna forma ,,lord'' (,,lady''), używana
	czasem w średnio formalnych sytuacjach.
\end{itemize}

Zamiast zaimku \textsc{2SG} w formalnej mowie w stosunku do osoby szlachetnie
urodzonej można stosować również:

\begin{itemize}
	\item \emph{rige/rigea} -- ,,władca'' (,,władczyni''), używane w odniesieniu
	do Cesarza, Króla lub Księcia, niezbyt formalne,
	\item \emph{arḱer/arḱera} -- ,,lord'' (,,lady''), używane w odniesieniu do
	osoby szlachentnie urodzonej, średnio formalne.
\end{itemize}
...
W ten sam sposób używa się również określenia \emph{ajor}. \emph{ajor} to
obecnie funkcja, sprawowana także przez osoby niepochodzące ze szlachty, jednak
używa się go identycznie z uwagi na uwarunkowania historyczne.
