...
Negation marker is a particle \randro{no}, which is \textbf{head-final} for
verbs. There is quite a lot of texts in which negation marker is used
head-initial, but this is very incorrect.

\note{In some religious texts and formal contexts, \randro{no} particle may be found always at the end of the sentence.}
...
\glossex{Egi karlet no il rige.}{egi karle-t no il rige}{3SG kill-PST NEG 3SG.POSS lord}{``He did not killed his lord.''}
...
\glossex{Chet mi va epit seysi?}{chet mi va epi-t seysi}{here 1SG PFV be.able-PST sit}{``Was I able to sit here?''}

The emphasis particle, \randro{vay} may be used to place an emphasis to a
question:

\glossex{Vay a tyi patal ti kipeni?}{vay a tyi patal ti kipeni}{really.EMPH on 2SG.POSS father.DIM 2SG model}{``Are you really imitating your dad?''}
...
\glossex{So tyi vahuryiáysi o ti famei?}{so tyi vahuryiáysi fo ti famei}{what.Q 2SG.POSS tatoo DAT 2SG mean}{``What does your tatoo mean for you?''}
...
Similarly, the subortinate clause can also be attached with the conjunction
particle:
...
However, you may encounter sometimes usage of the \randro{chu} particle.

, sometimes
there is a need to mark the noun as the object. This is used mostly in the case
of additional emphasis and \randro{chu} particle is used. The \randro{chu}
...
Let's start with the possesive particle, \randro{yi}. As mentioned in the
morphology section, \randro{yi} is marking the possesive and is working in
...
\glossex{Mi esi in mibozor.}{mi esi in mibozor}{1SG be.PRS in.LOC school}{,,Jestem w szkole.'' \\ ,,Jestem teraz w szkole.''}
