...
\andro, as mentioned earlier, is mostly head-final, but it is sometimes
head-initial as well. This variation is caused by its complicated history. In
this chapter, different types of sentence structure will be presented, so you
will be able to understand how different clauses work in general.
...
\begin{itemize}
    \item \randro{epi} -- ``to may'' or ``to be able to'',
...
may encounter the head-final form after the verb, as a separate word.
...
example \tandro{Pazi fesgai.}{I like reading.} you must not use \randro{na} in
the style of \randro{Pazi fesgai na.}.

\subsection{Negations}

Negation marker is a particle \randro{no}, which is used in a
\textbf{head-initial} way in verb clauses, normally after the verb. In negative
imperatives, it precedes the lexical verb and remains before the final imperative
marker.
...
\glossex{Ze karli moĺi.}{ze karli moĺi}{FUT die never.ADV}{``I will never die!''}

\glossex{Ze karli no moĺi.}{ze karli no moĺi}{FUT die NEG never.ADV}{``I will never die!''}
...
\glossex{Il maŕie͞o egi koóli?}{il maŕie͞o egi koóli}{3SG.POSS spouse 3SG love}{``Does she love her husband?'' \\ ``Does he love his wife?'' \\ ``Does she love her spouse?''}

\note{Both \emph{egi} and \emph{marié͞o} may be used for all genders.}

\glossex{Il hinna egi esi?}{il hinna egi esi}{3SG.POSS girlfriend 3SG COP}{``Is her his girlfriend?''}

\glossex{Sotak epié karlet?}{sotak epié karle-t}{somebody 2SG.M.FRM kill-PST}{``Sir, have you killed someone?''}

\glossex{Je rujaler epié ze va karla͞i?}{Je rujaler epié ze va karla͞i}{DEM man 2SG.M.FRM FUT PFV kill}{``Sir, will you kill this man?''}

\glossex{Mi epié ze vi karla͞i?}{mi epié ze vi karla͞i}{1SG 2SG.M.FRM FUT IPFV kill}{``Sir, will you try to kill me?''}

\glossex{Il alye epiá veyt hetay?}{il alye epiá vey-t hetay}{3SG.POSS friend 2SG.F.FRM see-PST today}{``Have you seen your friend today, madam?''}
...
For the same purpose, \randro{elĺa} may be used, however is commonly perceived
as informal.

\glossex{Elĺa tyi patal ti kipeni?}{elĺa tyi patal ti kipeni}{really.EMPH.NFRM 2SG.POSS father.NFRM 2SG model}{``Are you really imitating your dad?''}
...
questions related to the possession, method, place, time or number.
...
\glossex{Yasu ti iéni?}{yasu ti i-éni}{from.where.Q 2SG VEN-go}{``Where do you came from?''}

\glossex{Yasu ti iént?}{yasu ti i-én-t}{from.where.Q 2SG VEN-go-PST}{``Where did you came from?''}
...
\glossex{So tyi vahuryiáysi o ti famei?}{so tyi vahuryiáysi fo ti famei}{what.Q 2SG.POSS tattoo DAT 2SG mean}{``What does your tattoo mean for you?''}
...
\begin{itemize}
    \item \randro{in} -- in,
    \item \randro{on} -- on (spatially),
    \item \randro{an} -- above,
    \item \randro{a} -- on (spatially) (Desert dialect),
    \item \randro{ne͞a} -- close, near,
    \item \randro{ner} -- close, near (spatially),
    \item \randro{churche} -- through,
    \item \randro{chet} -- here,
    \item \randro{dyet} -- behind (spatially),
    \item \randro{huhu} -- ahead (temporally), after,
    ...
    \item \randro{temu} -- behind (temporally), before,
    \item \randro{alive} -- ahead (temporally), after.
\end{itemize}
...
\glossex{Mi vayareni in Ameriḱa.}{mi vayareni in amerika}{1SG travel in.LOC amerika}{``I travel to the United States.''}
...
\glossex{Yelonayi ati bove aśtot ne͞a meńi.}{yelona-yi a-ti bove aśto-t ne͞a meńi}{queue-POSS one-ORD boy stop-PST near entrance}{``The first boy in the line stopped at the entrance.''}
...
\glossex{Ezimrukyi ardo͞em munerojila, Alyona yi Zaálta, esi aka kankuseros.}{Ezimruk-yi ardo-em muner-o-jila Alyona yi Zaálta esi a-ka kankuser-os}{Ezimruk-POSS high-SUPL office-ADJ-power council POSS nation COP one-two minister-PL}{``Ezimruk's highest authority, the National Council, is consisted of twelve ministers.''}
...
The ambiguity is solvable only by understanding the context of the sentence.
...
\glossex{Mi pazi karié himji.}{mi pazi karié him-ji}{1SG like beautiful woman-PL}{``I like beautiful women.''}

\glossex{Mi pazi karié himji e chid kahokapataji.}{mi pazi karié him-ji e chid kahokapata-ji.}{1SG like beautiful woman-PL and fast aeroplane-PL}{``I like beautiful women and fast aeroplanes.''}
...
\glossex{Waril vayarji esi lipe aloser che karié sipalima.}{Waril vayar-ji esi lipe aloser che karié sipalima}{long.ADJ travel-PL COP good.ADJ source GEN beautiful story}{``Long travels are good source for a beautiful story.''}

There is no preference in order of adjectives, when there is more than one
...
\subsection{A quite specific case: more than the most}

A beginning of a fairy tale or a legend is typically marked with a very special
phrase, which is also using a quite specific comparison adjective phrase:

\glossex{In vekka vyekka baán}{in vek-ka vyekka baán}{LOC old-COMP old.SUPL time}{``In the older than the oldest times.''}

A phrase structure of comparative and superlative form of the same adjective is
meaning ``more than the most'' and is used without any comparative particle.

\glossex{gruwe͞a gruwe͞am}{gruwe-a gruwe-am}{big-COMP big-SUPL}{``Bigger than the biggest.''}

It is a very old phrase structure, and mostly unused in typical speech.

\note{In the North, typically the beginning of the legend is shorter, usually
    \randro{in vek vek baán}, ``in the old old time'', while in the West they are
    using a very long version in traditional tales: \randro{in vekka vyekka baán,
        volu ari e rechakwa isdam est}, ``in the older than the oldest time, when the
    sky and the ocean were the one''.}

\subsection{Adverbial phrases}
\label{sec:adverbs}

As mentioned in the \nameref{sec:morph-adjectives}, adjectives may describe not
only a noun, but also a verb, performing the role of an adverb and answering the
question ``how?''. In adverbial phrases, the adjective follows the verb, making
the phrase \textbf{head-initial}; adjective phrases modifying nouns are
\textbf{head-final}.
...
\glossex{Aḱame osupi.}{aḱame osupi}{rain fall.PRS.IPFV}{``It is raining.''}
...
\note{In informal speech, \randro{heme} is sometimes elongated to a form of
...
\randro{vige} is used in the context of a wish, when you are wishing someone or
something to be successful.

In general case, \randro{livi} (go forward) verb may be used for wishing
something to continue.

\glossex{Supiritara vige livi!}{supiritara vige livi}{revolution OPT go.forward}{``The revolution shall go forward!'' \\ ``Long live the revolution!''}

However, in case of people, the \randro{lipe} (good, well) or \randro{menede}
adjectives are used more commonly.

\glossex{Kyige vige loti menede!}{kyige vige loti menede}{king OPT live healthy.ADV}{``The king shall live in health!''}

\glossex{Kyige vige loti lipe!}{kyige vige loti lipe}{king OPT live good.ADV}{``The king shall live well!'' \\ ``Long live the king!''}

In both cases, adjective may be omitted, and the verb itself is enough.
Sometimes, especially in the Southern dialect, the verb is omitted.

\glossex{Ti vige lipe!}{ti vige lipe}{2SG OPT good}{``Good luck!''}

Also in the Southern dialect, they use \randro{micha}, a noun meaning ``life's
worth'', essentially wishing the person that their life should have worth.

\glossex{Kyige vige avi micha!}{kyige vige avi micha}{king OPT have lifes.worth}{``The king's life shall have its worth!''\\``The king shall have his life's worth!''\\``Long live the king!''}
...
\glossex{Ti uneńi epi.}{ti uneńi epi}{2SG leave can.IMP.FRM}{``You may leave.'' \\ ``You are dismissed.''}
...
The general usage of demonstratives is described in \nameref{sec:dem}, but there
are some additional caveats.

As mentioned, \randro{je} and \randro{ja} are used when referring to some kind
...
\glossex{Je vechiret Kasstor!}{je vechiret kasstor}{DEM.EMPH stupid Kasstor}{``That stupid Kasstor!''}
