...
In some dialects, the topic marker \randro{ya} is used to mark what is the topic
of the sentence, and what is the state of the topic.
...
As mentioned in the {sec:morph-adjectives}, you can create an adjective out of a
verb, by changing the ending \xo{-i} into \xo{-o}.
...
As mentioned in the \refname{sec:morph-adjectives}, adjectives may describe not
...
\glossex{Mi fesgai eveni tay.}{mi fesgai eveni tay}{1SG read.PRS every.ADJ day}{``I read every day.''}
...
\note{in case of the rain, it must be noted, that \randro{osupi} is mostly used
    for the rain, so even the form \randro{Osupi.} is a correct sentence describing
    that is is raining at the moment.}
