...
\note{The people of Maŕid and Earth are the same species, yet there is no
      information available at the moment on how they appeared so far from Earth.}
\skipline
...
language (also known as Imperial or Royal Language) (\tandro{eygepa inrat}{royal
      language}). The Imperial And́royasan was partially artificial -- it was
...
loss of the the form of the future tense in favor of the particle \randro{ze}, a
change in the syntax of particles \randro{do} and \randro{hemi}, the loss of the
vowel \xm{y}, the geminants \xm{rr} and \xm{pp} and~a number of other phonetic
changes.
...
Izolan, is preferring usage of possesive suffix \randro{-yi} instead of
...
instead of \xt{ʐ}, and sometimes \xt{h} zamiast \xt{x}.
