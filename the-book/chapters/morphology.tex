...
a singular noun, apart from a few specific cases.
...
case of an inanimate object which is closer to listener than to speaker.
...
a diphthong, e.g. \tandro{chikai}{to laugh} is \xm{'ʈ͡ʂi.ka.i}, many users are
...
comparative form is ending with \xo{-e͞a}, and superlative -- \xo{-e͞am}. Unfortunately,
there is no regularity.

Comparative form is obviously used in comparisons.

\glossex{Mi esi guste͞a o ti.}{mi esi gust-ea o ti}{1SG COP happy-COMP COMP 2SG}{``I am happier than you.''}

\glossex{Zetay ze esi votepo͞e o hetay.}{zetay ze esi votepo-e o hetay}{tomorrow FUT COP hot-COMP COMP today}{``Tomorrow there will be hotter than today.''}
