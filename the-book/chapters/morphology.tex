...
include a diphtong, e.g. \randro{chikai} \xm{'ʈ͡ʂi.ka.i} ``to laugh'', many
users are pronouncing endings like \xo{-ai}, \xo{-ei}, \xo{-oi} as \xt{ay} or
\xt{aʲi}.

\note{In \ardo, and in families aspiring to the ``higher'' classes, there was a
  huge emphasis on proper pronounciation of infinitive verbs, as this was one of
  the features distinguishing from the lower social classes. That caused some
  people pronouncing with a visible pause, accent or even glottal stop
  \xt{ˈʈ͡ʂi.ka.ʔi}.}

\subsection{Nominalization}

A verb can be changed into a noun by the usage of \xo{na} particle, the
...
most cases, basic form of the adjective is ending with \xo{-o}, while
...
\randro{erokwa}, ``chicken'', saying that the meat was actually posessed by the
chicken. In case of the metal blade, \randro{zokemo} is used to say ``made from
the metal''.

In case of verbs, only \xo{-o} suffix is used -- the basic form of the verb
(ending with \xo{-i}) has their suffix changed into \xo{-o} to create a new
adjective.
...
In case of numbers ending with one, \randro{a}, accent is changing to the last
syllable for easier recognition \xm{ka.ta.ˈa}, but one may notice this way is
horribly inefficient for larger numbers, e.g. million would be
\randro{awawawawawawa}, while even simple ``one hunder and eleven'' --
...
the usage of the \xo{jo} particle, meaning ``and'', but the same particle may be
...
\note{It is being said sometime that everybody in And́royas is using a scientific notation for large numbers, saying things like ``one and nine zeroes''.}
