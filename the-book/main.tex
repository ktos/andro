...
\newcommand{\randro}[1]{{\textit{#1}}} % romanization
\newcommand{\andro}{\emph{andro}\xspace} % language name
\newcommand{\ardo}{\emph{ardo andro}\xspace} % language variant name
\newcommand{\tandro}[2]{\textit{#1}\footnotemark\footnotetext{\textit{andr.} #2}} % romanization + translation
