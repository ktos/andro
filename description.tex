...
\note{Głoski /ɡʱ/ oraz /ʁ/ nie występują w~\emph{ardo andro}, jedynie w~
niektórych dialektach. Głoski [ʐ] oraz [x] mogą być również
wymawiane jako [ʒ] oraz [h], odpowiednio. Jest to traktowane normalnie
w dialektach i~jako błąd w~\emph{ardo andro}.}\skipline
...
\example{Ja much esi ruko.}{ten (konkretny) kot jest czarny}
...
\example{Myi futomameryi esi dowo chu yasaji.}{Mój poduszkowiec jest pełen 
[kogo, czego?] węgorzy.}
...
\examples{Mi fesgai evni tay.}{Czytam każdego dnia.}

\example{Mi kooli ti relita.}{Kocham cię na zawsze.}
...
\example{Mi vi kiruk feni, abe va tayet.}{Umiałem pływać, ale zapomniałem.}
...
\examples{Mi epi cher seysi.}{Mogę tutaj usiąść.}
...
\examples{Mi va koolit egi.}{Kochałem ją/jego [ale przestałem].}

\example{Egi palimit au mi.}{On rozmawiał ze mną.}
...
\example{Sotak ge karlat [chu] sotak.}{Ktoś został zabity przez kogoś.} 
...
\examples{Sotak karlat sotak.}{Ktoś zabił kogoś.}
...
\examples{Toi tort deito do!}{Wy rzućcie broń!}

\example{Tort deito do!}{[Ty] rzuć broń!}
...
\examples{Ti tort deito hemi.}{Rzuć proszę broń/czy mógłbyś rzucić broń?}
...
\examples{Tort no deito do!}{Nie rzucaj broni!}
...
\examples{Il maŕie͞o egi kooli?}{Czy on kocha swoją żonę?}
...
\examples{Cher mi epi seysi?}{Czy mogę tutaj siąść?}

\note{Można by również zapytać \emph{Cher mi vi epi seysi?}, ale prawdopodobnie 
zostało by to uznane za pretensjonalne aspirowanie do wyższych sfer.}

\example{Cher mi va ep seysi?}{Czy mogłem tutaj siąść?}
...
\examples{Yase ti iéni?}{Skąd pochodzisz?}
...
\example{Vaj a~tyi patal ti kipeni?}{Czy naprawdę wzorujesz się na swoim ojcu?}
...
\example{Cherlok Holms va choint sospet kayetor esi no, e egi o jan fari 
...
deito lipe va kopet.}{Sherlock Holmes stwierdził, że podejrzany nie jest 
...
\example{Ari esi ya͞en, koe vipetode yi much esi.}{Niebo jest niebieskie, tak, 
jak miska kota [jest].}
...
\examples{Pakopo rulajar kant hetay ne͞a ji͞ari͞o in Lublin.}{Zmartwiony mężczyzna 
śpiewał dzisiaj obok ogrodu w~Lublinie.}

\examples{Rulajar chu vi pakop kant hetay ne͞a ji͞ari͞o in Jechuf.}{Mężczyzna, 
który się martwił, śpiewał dzisiaj obok ogrodu w~Rzeszowie.}

\examples{Much che altur vi fart}{Kot, który robił hałas}

\examples{Altur faro much}{Kot robiący hałas}

\example{Alturo much}{Hałasujący kot}
...
Wynika to z~faktu, że Jego Wysokość pochodzi z~Jizivy, gdzie pojawiają się 
takie, unikatowe, elementy języka, z~uwagi na wpływ języków krajów ościennych.}
